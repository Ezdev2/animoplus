...
import { useUpdateService } from '@/services/services/serviceQueries.js'
...
// État du formulaire - initialisé avec les données du service
...
// Fonction pour pré-remplir le formulaire avec les données du service
...
async function submitForm() {
  ...
  try {
    ...
    console.log('📤 Modification du service ID:', props.service.id)
    console.log('📤 Données de modification:', serviceData)
...
// Watcher pour détecter les changements de service
...
// Initialisation
onMounted(() => {
  console.log('🚀 Modal de modification de service initialisé')
  console.log('🔧 Service à modifier:', props.service)
